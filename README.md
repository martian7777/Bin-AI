...
<a href="https://github.com/martian7777/Bin-AI/releases/latest/download/BinAI.dmg">
  <img src="./assets/macos-badge.png" alt="Download Bin AI for macOS" width="180" />
</a>
...
<sub><i>Requires macOS 26 (Tahoe) on Apple Silicon / Windows 10/11</i></sub>
...
Bin AI is an open source video editor for Mac. You and your agent can generate and edit videos together inside the timeline.

### Swift-native video editor

We built Bin AI from scratch with Swift. The north star is Premiere Pro, with our take on integrating AI into the workflow.
...
- **Feedback &amp; Support:** Create a [Github Issue](https://github.com/martian7777/Bin-AI/issues)
...
Bin AI is open source under [GPLv3](LICENSE).
