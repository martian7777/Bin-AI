...
So we built Bin AI to solve these issues. The video editor is the single source of truth. You can use your own AI agent to do scripting, generating, and editing with all the context you need.
...
3. Much more interesting use cases with integrating with other workflows. Since Bin AI is just a MCP server, you can connect your video editor with other MCP servers all in one chat, so context is centralized.

Some examples on using Bin AI MCP server with Claude:

1. Write your idea and script in Claude, then ask it to generate videos inside Bin AI
2. Pull sound effect from Epidemic Sound MCP server and import to Bin AI MCP server
3. Pull your team's idea in #marketing Slack channel and create a quick prototype in Bin AI
...
**What is the future of Bin AI?**

We envision Bin AI as the future of video editing, a UI for both humans and agents. We strongly believe agents cannot replicate human creativity, but in the process of generating and editing videos, there is a lot of manual work that AI can help with.