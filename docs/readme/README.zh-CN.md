...
Bin AI 是面向 Mac 的开源视频编辑器。你和你的 agent 可以在时间线中一起生成和编辑视频。

### Swift 原生视频编辑器

我们用 Swift 从零构建了 Bin AI。参考目标是 Premiere Pro，并以我们自己的方式把 AI 融入工作流。
...
<a href="https://www.star-history.com/?type=date&repos=martian7777%2FBin-AI">
 <picture>
   ...
   <img alt="Star History 图表" src="https://api.star-history.com/chart?repos=martian7777/Bin-AI&type=date&legend=top-left" />
 </picture>
</a>
